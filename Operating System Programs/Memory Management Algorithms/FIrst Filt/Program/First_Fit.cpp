...
void First_Fit(vector<memoryBlocks> &memBlocks, int noOfBlocks, vector<pair<int, string>> &processSizes, int noOfProcess)
{
...
Blocks Sizes -> 200 100 300 400 500
Process Sizes -> 250 200 100 350
